  ...
  return Array.from({ length: count }, (_, index) => {
      ...
      return {
          ...
          interviewDates: {
              ...
              technical: faker.date.between({ from: interviewDate, to: new Date() }) || null,
              hr: faker.date.between({ from: interviewDate, to: new Date() }) || null,
          },
          interviewers: [
          ...
          vacationSickLeaves: faker.number.int({ min: 0, max: 20 }),
          currentSalary: faker.number.float({ min: 50000, max: 150000, precision: 0.01 }),
          expectedSalaryIncrease: faker.number.float({ min: 0.01, max: 0.1, precision: 0.01 }),
      };
  });
};
